...
def _profile_to_artist_defaults(profile: dict, job):
    ...
    return {
        ...
        "city": locale.get("city") or locale.get("active_city") or profile.get("city", ""),
        "country": locale.get("country") or profile.get("country", ""),
        "bio": profile.get("bio", ""),
        "spotify_url": platforms.get("spotify") or profile.get("spotify_url", ""),
        "youtube_url": platforms.get("youtube") or profile.get("youtube_url", ""),
        "instagram_url": platforms.get("instagram") or profile.get("instagram_url", ""),
        "website_url": platforms.get("website") or profile.get("website_url", ""),
